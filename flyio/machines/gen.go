...
const (
	FlyMachineRootfsPersistAlways  FlyMachineRootfsPersist = "always"
	FlyMachineRootfsPersistNever   FlyMachineRootfsPersist = "never"
	FlyMachineRootfsPersistRestart FlyMachineRootfsPersist = "restart"
)
...
func (e FlyMachineRootfsPersist) Valid() bool {
	switch e {
	case FlyMachineRootfsPersistAlways:
		return true
	case FlyMachineRootfsPersistNever:
		return true
	case FlyMachineRootfsPersistRestart:
		return true
	default:
		return false
	}
...
const (
	MainStatusCodeCapacityErr                MainStatusCode = "insufficient_capacity"
	MainStatusCodeNameTakenErr               MainStatusCode = "name_taken"
	MainStatusCodeUnknown                    MainStatusCode = "unknown"
	MainStatusCodeVolumePlacementCapacityErr MainStatusCode = "volume_placement_capacity"
)

// Valid indicates whether the value is a known member of the MainStatusCode enum.
func (e MainStatusCode) Valid() bool {
	switch e {
	case MainStatusCodeCapacityErr:
		return true
	case MainStatusCodeNameTakenErr:
		return true
	case MainStatusCodeUnknown:
		return true
	case MainStatusCodeVolumePlacementCapacityErr:
		return true
	default:
		return false
	}
...
type ClientInterface interface {
	...
	//
	// Corresponds with DELETE /v1/apps/{app_name} (the `AppsDelete` operationId).
	...
	//
	// Corresponds with GET /v1/apps/{app_name} (the `AppsShow` operationId).
	AppsShow(ctx context.Context, appName string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// AppCertificatesList List certificates for app
	//
	// Corresponds with GET /v1/apps/{app_name}/certificates (the `AppCertificatesList` operationId).
	...
	// AppCertificatesAcmeCreateWithBody Request ACME certificate
	//
	// Takes any type of body and a specified content type.
	//
	// Corresponds with POST /v1/apps/{app_name}/certificates/acme (the `AppCertificatesAcmeCreate` operationId).
	...
	// AppCertificatesAcmeCreate Request ACME certificate
	//
	// Takes a body of the `application/json` content type.
	//
	// Corresponds with POST /v1/apps/{app_name}/certificates/acme (the `AppCertificatesAcmeCreate` operationId).
	...
	// AppCertificatesDelete Remove certificate
	//
	// Corresponds with DELETE /v1/apps/{app_name}/certificates/{hostname} (the `AppCertificatesDelete` operationId).
	AppCertificatesDelete(ctx context.Context, appName string, hostname string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// AppCertificatesShow Get certificate details
	//
	// Corresponds with GET /v1/apps/{app_name}/certificates/{hostname} (the `AppCertificatesShow` operationId).
	AppCertificatesShow(ctx context.Context, appName string, hostname string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// AppCertificatesCheck Check DNS and re-validate certificate
	//
	// Corresponds with POST /v1/apps/{app_name}/certificates/{hostname}/check (the `AppCertificatesCheck` operationId).
	AppCertificatesCheck(ctx context.Context, appName string, hostname string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// AppIPAssignmentsList List IP assignments for app
	//
	// Corresponds with GET /v1/apps/{app_name}/ip_assignments (the `AppIPAssignmentsList` operationId).
	AppIPAssignmentsList(ctx context.Context, appName string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// AppIPAssignmentsCreateWithBody Assign new IP address to app
	//
	// Takes any type of body and a specified content type.
	//
	// Corresponds with POST /v1/apps/{app_name}/ip_assignments (the `AppIPAssignmentsCreate` operationId).
	...
	// AppIPAssignmentsCreate Assign new IP address to app
	//
	// Takes a body of the `application/json` content type.
	//
	// Corresponds with POST /v1/apps/{app_name}/ip_assignments (the `AppIPAssignmentsCreate` operationId).
	...
	// AppIPAssignmentsDelete Remove IP assignment from app
	//
	// Corresponds with DELETE /v1/apps/{app_name}/ip_assignments/{ip} (the `AppIPAssignmentsDelete` operationId).
	...
	// Takes any type of body and a specified content type.
	//
	// Corresponds with POST /v1/apps/{app_name}/machines (the `MachinesCreate` operationId).
	...
	//
	// Corresponds with DELETE /v1/apps/{app_name}/machines/{machine_id} (the `MachinesDelete` operationId).
	...
	//
	// Corresponds with GET /v1/apps/{app_name}/machines/{machine_id} (the `MachinesShow` operationId).
	...
	// MachinesUpdateWithBody Update Machine
	//
	// Update a Machine's configuration using the details provided in the request body.
	//
	// Takes any type of body and a specified content type.
	//
	// Corresponds with POST /v1/apps/{app_name}/machines/{machine_id} (the `MachinesUpdate` operationId).
	...
	//
	// Corresponds with GET /v1/apps/{app_name}/machines/{machine_id}/events (the `MachinesListEvents` operationId).
	...
	//
	// Corresponds with POST /v1/apps/{app_name}/machines/{machine_id}/start (the `MachinesStart` operationId).
	MachinesStart(ctx context.Context, appName string, machineId string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// MachinesStopWithBody Stop Machine
	//
	// Stop a specific Machine within an app, with an optional request body to specify signal and timeout.
	//
	// Takes any type of body and a specified content type.
	//
	// Corresponds with POST /v1/apps/{app_name}/machines/{machine_id}/stop (the `MachinesStop` operationId).
	...
	//
	// Corresponds with GET /v1/apps/{app_name}/machines/{machine_id}/wait (the `MachinesWait` operationId).
	...
	//
	// Corresponds with GET /v1/apps/{app_name}/secrets (the `SecretsList` operationId).
	SecretsList(ctx context.Context, appName string, params *SecretsListParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// SecretsUpdateWithBody Update app secrets belonging to an app
	//
	// Takes any type of body and a specified content type.
	//
	// Corresponds with POST /v1/apps/{app_name}/secrets (the `SecretsUpdate` operationId).
	...
	// SecretsUpdate Update app secrets belonging to an app
	//
	// Takes a body of the `application/json` content type.
	//
	// Corresponds with POST /v1/apps/{app_name}/secrets (the `SecretsUpdate` operationId).
	...
	//
	// Corresponds with DELETE /v1/apps/{app_name}/secrets/{secret_name} (the `SecretDelete` operationId).
	...
	//
	// Corresponds with GET /v1/apps/{app_name}/secrets/{secret_name} (the `SecretGet` operationId).
	...
	//
	// Corresponds with DELETE /v1/apps/{app_name}/volumes/{volume_id} (the `VolumeDelete` operationId).
	...
	//
	// Corresponds with GET /v1/apps/{app_name}/volumes/{volume_id} (the `VolumesGetById` operationId).
	VolumesGetById(ctx context.Context, appName string, volumeId string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// VolumesUpdateWithBody Update Volume
	//
	// Update a volume's configuration using the details provided in the request body.
	//
	// Takes any type of body and a specified content type.
	//
	// Corresponds with PUT /v1/apps/{app_name}/volumes/{volume_id} (the `VolumesUpdate` operationId).
	...
	// VolumesExtendWithBody Extend Volume
	//
	// Extend a volume's size within an app using the details provided in the request body.
	//
	// Takes any type of body and a specified content type.
	//
	// Corresponds with PUT /v1/apps/{app_name}/volumes/{volume_id}/extend (the `VolumesExtend` operationId).
...
// NewAppsListRequest constructs an http.Request for the AppsList method
...
// NewAppsCreateRequestWithBody constructs an http.Request for the AppsCreate method, with any body, and a specified content type
...
// NewAppsDeleteRequest constructs an http.Request for the AppsDelete method
...
// NewAppsShowRequest constructs an http.Request for the AppsShow method
...
// NewAppCertificatesListRequest constructs an http.Request for the AppCertificatesList method
...
// NewAppCertificatesAcmeCreateRequestWithBody constructs an http.Request for the AppCertificatesAcmeCreate method, with any body, and a specified content type
...
// NewAppCertificatesDeleteRequest constructs an http.Request for the AppCertificatesDelete method
...
// NewAppCertificatesShowRequest constructs an http.Request for the AppCertificatesShow method
...
// NewAppCertificatesCheckRequest constructs an http.Request for the AppCertificatesCheck method
...
// NewAppIPAssignmentsListRequest constructs an http.Request for the AppIPAssignmentsList method
...
// NewAppIPAssignmentsCreateRequestWithBody constructs an http.Request for the AppIPAssignmentsCreate method, with any body, and a specified content type
...
// NewAppIPAssignmentsDeleteRequest constructs an http.Request for the AppIPAssignmentsDelete method
...
// NewMachinesListRequest constructs an http.Request for the MachinesList method
...
// NewMachinesCreateRequestWithBody constructs an http.Request for the MachinesCreate method, with any body, and a specified content type
...
// NewMachinesDeleteRequest constructs an http.Request for the MachinesDelete method
...
// NewMachinesShowRequest constructs an http.Request for the MachinesShow method
...
// NewMachinesUpdateRequestWithBody constructs an http.Request for the MachinesUpdate method, with any body, and a specified content type
...
// NewMachinesListEventsRequest constructs an http.Request for the MachinesListEvents method
...
// NewMachinesStartRequest constructs an http.Request for the MachinesStart method
...
// NewMachinesStopRequestWithBody constructs an http.Request for the MachinesStop method, with any body, and a specified content type
...
// NewMachinesWaitRequest constructs an http.Request for the MachinesWait method
...
// NewSecretsListRequest constructs an http.Request for the SecretsList method
...
// NewSecretsUpdateRequestWithBody constructs an http.Request for the SecretsUpdate method, with any body, and a specified content type
...
// NewSecretDeleteRequest constructs an http.Request for the SecretDelete method
...
// NewSecretGetRequest constructs an http.Request for the SecretGet method
...
// NewVolumesListRequest constructs an http.Request for the VolumesList method
...
// NewVolumesCreateRequestWithBody constructs an http.Request for the VolumesCreate method, with any body, and a specified content type
...
// NewVolumeDeleteRequest constructs an http.Request for the VolumeDelete method
...
// NewVolumesGetByIdRequest constructs an http.Request for the VolumesGetById method
...
// NewVolumesUpdateRequestWithBody constructs an http.Request for the VolumesUpdate method, with any body, and a specified content type
...
// NewVolumesExtendRequestWithBody constructs an http.Request for the VolumesExtend method, with any body, and a specified content type
...
type ClientWithResponsesInterface interface {
	...
	// AppsListWithResponse List Apps
	//
	// List all apps with the ability to filter by organization slug.
	//
	...
	// AppsCreateWithBodyWithResponse Create App
	//
	// Create an app with the specified details in the request body.
	//
	...
	// AppsCreateWithResponse Create App
	//
	// Create an app with the specified details in the request body.
	//
	...
	// AppsDeleteWithResponse Destroy App
	//
	// Delete an app by its name.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// AppCertificatesListWithResponse List certificates for app
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with GET /v1/apps/{app_name}/certificates (the `AppCertificatesList` operationId).
	...
	// AppCertificatesAcmeCreateWithBodyWithResponse Request ACME certificate
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	//
	// Corresponds with POST /v1/apps/{app_name}/certificates/acme (the `AppCertificatesAcmeCreate` operationId).
	...
	// AppCertificatesAcmeCreateWithResponse Request ACME certificate
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	//
	// Corresponds with POST /v1/apps/{app_name}/certificates/acme (the `AppCertificatesAcmeCreate` operationId).
	...
	// AppCertificatesDeleteWithResponse Remove certificate
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with DELETE /v1/apps/{app_name}/certificates/{hostname} (the `AppCertificatesDelete` operationId).
	...
	// AppCertificatesShowWithResponse Get certificate details
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with GET /v1/apps/{app_name}/certificates/{hostname} (the `AppCertificatesShow` operationId).
	...
	// AppCertificatesCheckWithResponse Check DNS and re-validate certificate
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with POST /v1/apps/{app_name}/certificates/{hostname}/check (the `AppCertificatesCheck` operationId).
	...
	// AppIPAssignmentsListWithResponse List IP assignments for app
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with GET /v1/apps/{app_name}/ip_assignments (the `AppIPAssignmentsList` operationId).
	...
	// AppIPAssignmentsCreateWithBodyWithResponse Assign new IP address to app
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	//
	// Corresponds with POST /v1/apps/{app_name}/ip_assignments (the `AppIPAssignmentsCreate` operationId).
	...
	// AppIPAssignmentsCreateWithResponse Assign new IP address to app
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	//
	// Corresponds with POST /v1/apps/{app_name}/ip_assignments (the `AppIPAssignmentsCreate` operationId).
	...
	// AppIPAssignmentsDeleteWithResponse Remove IP assignment from app
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with DELETE /v1/apps/{app_name}/ip_assignments/{ip} (the `AppIPAssignmentsDelete` operationId).
	...
	// MachinesListWithResponse List Machines
	//
	// List all Machines associated with a specific app, with optional filters for including deleted Machines and filtering by region.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// MachinesCreateWithBodyWithResponse Create Machine
	//
	// Create a Machine within a specific app using the details provided in the request body.
	//
	// **Important**: This request can fail, and you’re responsible for handling that failure. If you ask for a large Machine, or a Machine in a region we happen to be at capacity for, you might need to retry the request, or to fall back to another region. If you’re working directly with the Machines API, you’re taking some responsibility for your own orchestration!
	...
	// MachinesCreateWithResponse Create Machine
	//
	// Create a Machine within a specific app using the details provided in the request body.
	//
	// **Important**: This request can fail, and you’re responsible for handling that failure. If you ask for a large Machine, or a Machine in a region we happen to be at capacity for, you might need to retry the request, or to fall back to another region. If you’re working directly with the Machines API, you’re taking some responsibility for your own orchestration!
	...
	// MachinesDeleteWithResponse Destroy Machine
	//
	// Delete a specific Machine within an app by Machine ID, with an optional force parameter to force kill the Machine if it's running.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// MachinesShowWithResponse Get Machine
	//
	// Get details of a specific Machine within an app by the Machine ID.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// MachinesUpdateWithBodyWithResponse Update Machine
	//
	// Update a Machine's configuration using the details provided in the request body.
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	...
	// MachinesUpdateWithResponse Update Machine
	//
	// Update a Machine's configuration using the details provided in the request body.
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	...
	// MachinesListEventsWithResponse List Events
	//
	// List all events associated with a specific Machine within an app.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// MachinesStartWithResponse Start Machine
	//
	// Start a specific Machine within an app.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// MachinesStopWithBodyWithResponse Stop Machine
	//
	// Stop a specific Machine within an app, with an optional request body to specify signal and timeout.
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	...
	// MachinesStopWithResponse Stop Machine
	//
	// Stop a specific Machine within an app, with an optional request body to specify signal and timeout.
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	...
	// MachinesWaitWithResponse Wait for State
	//
	// Wait for a Machine to reach a specific state. Specify the desired state with the state parameter. See the [Machine states table](https://fly.io/docs/machines/working-with-machines/#machine-states) for a list of possible states. The default for this parameter is `started`.
	//
	// This request will block for up to 60 seconds. Set a shorter timeout with the timeout parameter.
	...
	// SecretsListWithResponse List app secrets belonging to an app
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with GET /v1/apps/{app_name}/secrets (the `SecretsList` operationId).
	...
	// SecretsUpdateWithBodyWithResponse Update app secrets belonging to an app
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	//
	// Corresponds with POST /v1/apps/{app_name}/secrets (the `SecretsUpdate` operationId).
	...
	// SecretsUpdateWithResponse Update app secrets belonging to an app
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	//
	// Corresponds with POST /v1/apps/{app_name}/secrets (the `SecretsUpdate` operationId).
	...
	// SecretDeleteWithResponse Delete an app secret
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with DELETE /v1/apps/{app_name}/secrets/{secret_name} (the `SecretDelete` operationId).
	...
	// SecretGetWithResponse Get an app secret
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with GET /v1/apps/{app_name}/secrets/{secret_name} (the `SecretGet` operationId).
	...
	// VolumesListWithResponse List Volumes
	//
	// List all volumes associated with a specific app.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// VolumesCreateWithBodyWithResponse Create Volume
	//
	// Create a volume for a specific app using the details provided in the request body.
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	...
	// VolumesCreateWithResponse Create Volume
	//
	// Create a volume for a specific app using the details provided in the request body.
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	...
	// VolumeDeleteWithResponse Destroy Volume
	//
	// Delete a specific volume within an app by volume ID.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// VolumesGetByIdWithResponse Get Volume
	//
	// Retrieve details about a specific volume by its ID within an app.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// VolumesUpdateWithBodyWithResponse Update Volume
	//
	// Update a volume's configuration using the details provided in the request body.
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	...
	// VolumesUpdateWithResponse Update Volume
	//
	// Update a volume's configuration using the details provided in the request body.
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	...
	// VolumesExtendWithBodyWithResponse Extend Volume
	//
	// Extend a volume's size within an app using the details provided in the request body.
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	...
	// VolumesExtendWithResponse Extend Volume
	//
	// Extend a volume's size within an app using the details provided in the request body.
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
...
func (r AppsListResponse) GetBody() []byte {
	return r.Body
}
...
func (r AppsListResponse) ContentType() string {
	if r.HTTPResponse != nil {
...
func (r AppsCreateResponse) GetJSON400() *ErrorResponse {
	return r.JSON400
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r AppsCreateResponse) GetJSON422() *ErrorResponse {
	return r.JSON422
}

// GetBody returns the raw response body bytes
func (r AppsCreateResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppsCreateResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetBody returns the raw response body bytes
func (r AppsDeleteResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppsDeleteResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r AppsShowResponse) GetJSON200() *App {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r AppsShowResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppsShowResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r AppCertificatesListResponse) GetJSON200() *ListCertificatesResponse {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r AppCertificatesListResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppCertificatesListResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
func (r AppCertificatesAcmeCreateResponse) GetJSON201() *CertificateDetail {
	return r.JSON201
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r AppCertificatesAcmeCreateResponse) GetJSON422() *ErrorResponse {
	return r.JSON422
}

// GetBody returns the raw response body bytes
func (r AppCertificatesAcmeCreateResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppCertificatesAcmeCreateResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetBody returns the raw response body bytes
func (r AppCertificatesDeleteResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppCertificatesDeleteResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r AppCertificatesShowResponse) GetJSON200() *CertificateDetail {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r AppCertificatesShowResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppCertificatesShowResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r AppCertificatesCheckResponse) GetJSON200() *CertificateCheckResponse {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r AppCertificatesCheckResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppCertificatesCheckResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r AppIPAssignmentsListResponse) GetJSON200() *ListIPAssignmentsResponse {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r AppIPAssignmentsListResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppIPAssignmentsListResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r AppIPAssignmentsCreateResponse) GetJSON200() *AssignIPResponse {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r AppIPAssignmentsCreateResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppIPAssignmentsCreateResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetBody returns the raw response body bytes
func (r AppIPAssignmentsDeleteResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r AppIPAssignmentsDeleteResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetBody returns the raw response body bytes
func (r MachinesListResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r MachinesListResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r MachinesCreateResponse) GetJSON200() *Machine {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r MachinesCreateResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r MachinesCreateResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetBody returns the raw response body bytes
func (r MachinesDeleteResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r MachinesDeleteResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r MachinesShowResponse) GetJSON200() *Machine {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r MachinesShowResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r MachinesShowResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r MachinesUpdateResponse) GetJSON200() *Machine {
	return r.JSON200
}
...
// GetBody returns the raw response body bytes
func (r MachinesUpdateResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r MachinesUpdateResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r MachinesListEventsResponse) GetJSON200() *[]MachineEvent {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r MachinesListEventsResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r MachinesListEventsResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetBody returns the raw response body bytes
func (r MachinesStartResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r MachinesStartResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON400 returns the response for an HTTP 400 `application/json` response
func (r MachinesStopResponse) GetJSON400() *ErrorResponse {
	return r.JSON400
}

// GetBody returns the raw response body bytes
func (r MachinesStopResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r MachinesStopResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r MachinesWaitResponse) GetJSON200() *WaitMachineResponse {
	return r.JSON200
}

// GetJSON400 returns the response for an HTTP 400 `application/json` response
func (r MachinesWaitResponse) GetJSON400() *ErrorResponse {
	return r.JSON400
}

// GetBody returns the raw response body bytes
func (r MachinesWaitResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r MachinesWaitResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r SecretsListResponse) GetJSON200() *AppSecrets {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r SecretsListResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r SecretsListResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r SecretsUpdateResponse) GetJSON200() *AppSecretsUpdateResp {
	return r.JSON200
}

// GetJSON400 returns the response for an HTTP 400 `application/json` response
func (r SecretsUpdateResponse) GetJSON400() *ErrorResponse {
	return r.JSON400
}

// GetBody returns the raw response body bytes
func (r SecretsUpdateResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r SecretsUpdateResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r SecretDeleteResponse) GetJSON200() *DeleteAppSecretResponse {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r SecretDeleteResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r SecretDeleteResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r SecretGetResponse) GetJSON200() *AppSecret {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r SecretGetResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r SecretGetResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetBody returns the raw response body bytes
func (r VolumesListResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r VolumesListResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r VolumesCreateResponse) GetJSON200() *Volume {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r VolumesCreateResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r VolumesCreateResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r VolumeDeleteResponse) GetJSON200() *Volume {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r VolumeDeleteResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r VolumeDeleteResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r VolumesGetByIdResponse) GetJSON200() *Volume {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r VolumesGetByIdResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r VolumesGetByIdResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r VolumesUpdateResponse) GetJSON200() *Volume {
	return r.JSON200
}

// GetJSON400 returns the response for an HTTP 400 `application/json` response
func (r VolumesUpdateResponse) GetJSON400() *ErrorResponse {
	return r.JSON400
}

// GetBody returns the raw response body bytes
func (r VolumesUpdateResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r VolumesUpdateResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r VolumesExtendResponse) GetJSON200() *ExtendVolumeResponse {
	return r.JSON200
}

// GetBody returns the raw response body bytes
func (r VolumesExtendResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r VolumesExtendResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
